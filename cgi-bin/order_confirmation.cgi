#!/usr/bin/perl 
# Displays the order placed by the customer.
#
...
my $name = "jadrn033";
my $pwd = "tile";
my $db_src = "dbi:mysql:jadrn033:opatija.sdsu.edu:3306";
my $query_to_execute;
...
if (@SKUArray) {
    for (my $count = 0; $count < @SKUArray; $count++) {
        ...
        $query_to_execute = $dbh->prepare("INSERT INTO orderinfo(orderdate,sku,title,quantity,cost,retail) VALUES
